...
<div id="load{$id}_chart" style="height: 300px; width: 100%;"></div>
	...
	<div id="speedtest{$id}_upload_chart" style="height: 300px; width: 100%;"></div>
	...
	<script type="text/javascript">
		$().ready(function(){
			...
			speedtest_upload_chart{$id} = new CanvasJS.Chart("speedtest{$id}_upload_chart",
			{
				title:{
					text: "最近节点上传速度报告 {$prefix}"
				},
				axisY: {				
					suffix: " Mbps"
				},
			...
			speedtest_upload_chart{$id}.render();

                              ...
                              <div class="flat-carousal">
                                  <div id="owl-demo" class="owl-carousel owl-theme tab-content">
                                      ...
                                      <div role="tabpanel" class="item tab-pane" id="android">
                                          <h1>Android <a class="downloads" href="/downloads/client/ssr_3.1.5.1.apk">下载这个</a>，安装，然后在手机上默认浏览器中点击<a class="downloads" href="{$android_add}">这个</a>，然后一直点击确定，批量添加完服务器，然后路由选择绕过大陆，右上角开启就可以上网了。(此方法还在测试中，可能会出现问题)</h1>
                                      </div>

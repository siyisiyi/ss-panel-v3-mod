                              ...
                              <div class="flat-carousal">
                                  <div id="owl-demo" class="owl-carousel owl-theme tab-content">
                                      ...
                                      <div role="tabpanel" class="item tab-pane" id="ios">
                                          <h1>iOS 购买<a class="downloads" href="https://itunes.apple.com/cn/app/potatso-yi-jian-shi-pin-app/id1070901416?mt=8" target="_blank">土豆丝</a>或者<a href="https://itunes.apple.com/cn/app/shadowrocket-for-shadowsocks/id932747118" target="_blank" class="downloads">小火箭</a>，觉得贵就淘宝或者查看本站的<a class="downloads" href="/user/announcement">共享账号</a>，然后扫描二维码或者手动输入服务器信息即可。Surge配置文件<a href="/downloads/GoSiyi_Surge.conf">点击下载</a>。ShadowRocket配置文件<a class="downloads" href="/downloads/gosiyi_sr.conf">点击下载</a></h1>
                                      </div>
                                  </div>
                              </div>
                              <div class="panel-body">

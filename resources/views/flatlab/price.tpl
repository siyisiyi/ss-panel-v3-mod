            ...
            <div class="col-md-10 col-md-offset-1" id="main">
                ...
                <div class="">
                    <div class="text-center">
                        <p>
                            默认按需付费，2G≈￥1<sup>***</sup>，需要多少流量充多少。<br/>不必担心服务不稳定，更不必担心供应商跑路。<br/>
                ...
                <div>
                    <hr>
                    <small class="">
                        *开通费为一次性收费。实际消耗流量仍需另行付费。2GB≈1元<sup>***</sup>。<br/>
                        **中转加速为精品线路，流量比例为1.5倍。2GB≈1.5元<sup>***</sup>。<br/>
                        ***5折充值活动截止至8月28日23:59，之后恢复为充值1GB≈1元，精品线路流量为1GB≈1.5元
                    </small>
                </div>
            </div> <!-- end of main -->
        </div> <!-- end of row -->

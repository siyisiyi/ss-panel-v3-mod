                        	...
                        	<div class="col-lg-12 col-lg-push-0 col-sm-10 col-sm-push-1">
	                        	<div class="portlet box blue-hoki">
			                        ...
			                        <div class="portlet-body text-center">
										...
										<p>当前余额：{$user->money} 元  <a class="btn btn-sm blue" href="/user/code">充值</a></p>
										<div class="table-responsive">
											...
											<table class="table ">
					                            ...
					                            <tr>
													<td>
					                                    <a class="btn btn-sm blue" href="javascript:void(0);" onClick="buy('{$shop->id}',{$shop->auto_renew},{$shop->auto_reset_bandwidth})">购买</a>
					                                </td>
					                                <td>#{$shop->id}</td>
					                                <td>{$shop->name}</td>
													<td>{$shop->price} 元</td>
